...
<body class="font-sans bg-white text-dark mobil-page">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="text-center mb-12">
            <h1 class="text-4xl md:text-5xl font-bold mb-4 text-gray-800">Kurasi <span class="text-primary">Mobil</span> Terbaik</h1>
            <p class="text-gray-600 max-w-2xl mx-auto text-lg">Kami memilihkan mobil terbaik dari partner terpercaya di seluruh Lombok.</p>
        </div>
            ...
            <form action="{{ route('mobil.list') }}" method="GET" class="flex flex-col lg:flex-row gap-6 items-end">
                ...
                <div class="flex-1 w-full">
                    <label class="block text-gray-700 font-semibold mb-3 text-lg" for="search">
                        <i class="fas fa-search mr-2 text-primary"></i>Cari Mobil
                    </label>
                    <div class="search-box flex rounded-xl overflow-hidden bg-white transition-all border border-gray-200">
                        <input type="text"
                               ...
                               placeholder="Cari berdasarkan Nama Mobil, tipe, atau harga..."
                ...
                <div class="flex-1 w-full">
                    <label class="block text-gray-700 font-semibold mb-3 text-lg" for="category">
                        <i class="fas fa-filter mr-2 text-primary"></i>Kategori Mobil
                    </label>
                    <div class="relative">
        ...
        <!-- Car Cards -->
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="car-container">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-primary rounded-full flex items-center justify-center text-white text-sm font-bold mr-2">{{ $mobil->inisial_vendor }}</div>
                                <div>
                                    <div class="font-semibold">{{ $mobil->vendor }}</div>
                                    <div class="text-xs text-gray-500 flex items-center">
                                        <i class="fas fa-map-marker-alt mr-1"></i>
                                        <div class="font-semibold">{{ $mobil->lokasi }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
